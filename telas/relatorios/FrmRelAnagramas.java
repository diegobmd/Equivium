 ...
 * 
 */
public class FrmRelAnagramas extends FrmRelatorios {

   private final XPanel      panel           = new XPanel();

   private final XTableCampo taPesquisadores = new XTableCampo(1, 2, 70, 8, "Anagramas", new CAnagramas(0, 0, 0, ""));

   public FrmRelAnagramas() {
      super("Relatório de Anagramas");
...
//         JasperReport jasperReport = JasperCompileManager.compileReport("./relatorios/Anagramas.jrxml");
         
         parameters.put("sql", getWhere());

         JasperPrint jasperPrint = JasperFillManager.fillReport("./relatorios/Anagramas.jasper", parameters, XBanco.getConexao());
