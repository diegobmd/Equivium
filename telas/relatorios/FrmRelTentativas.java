 ...
 * 
 */
public class FrmRelTentativas extends FrmRelatorios {

   private final XPanel      panel           = new XPanel();

   private final XTableCampo taPesquisadores = new XTableCampo(1, 2, 70, 8, "Tentativas", new CSubFases(0, 0, 0, ""));

   public FrmRelTentativas() {
...
//         JasperReport jasperReport = JasperCompileManager.compileReport("./relatorios/Tentativas.jrxml");
         
         parameters.put("sql", getWhere());

         JasperPrint jasperPrint = JasperFillManager.fillReport("./relatorios/Tentativas.jasper", parameters, XBanco.getConexao());
